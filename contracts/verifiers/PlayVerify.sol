...
contract Groth16PlayVerifier {
    ...
    uint256 constant deltax1 = 1341069908687139156674369795531309650010213499034635506298465958328429235465;
    uint256 constant deltax2 = 12300350347495317134581222460939165078559612515851524002158866948779223003183;
    uint256 constant deltay1 = 10510515355361083984039336188136461590491940932104289341604498304631914450644;
    uint256 constant deltay2 = 4442781466644364659079389653578968612804607146150661047982748840205187265835;
    ...
    function verifyPlayProof(uint[2] calldata _pA, uint[2][2] calldata _pB, uint[2] calldata _pC, uint[7] calldata _pubSignals) public view returns (bool) {
        assembly {
